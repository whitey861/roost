// Roost: GitHub repo creation handler (Deno copy for Edge Functions).
//
// Paired with shared/tool-handlers/create-github-repo.ts. Keep both copies
// in sync; the chat-runtime dispatch relies on identical behaviour across
