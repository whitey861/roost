// Roost: Recraft image-generation handler (Deno copy for Edge Functions).
//
// Paired with shared/tool-handlers/generate-image.ts. Keep both copies in
// sync; the chat-runtime dispatch relies on identical behaviour across
// Node tests and the Deno production runtime.
