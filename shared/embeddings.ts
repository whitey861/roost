// Roost: Voyage AI embedding client (Node).
//
// Used during ingestion (scripts/ingest.ts) and at query time
// (shared/retrieval.ts). Uses native fetch.
//
// API: https://docs.voyageai.com/reference/embeddings-api
// Pricing: voyage-3 is 1024-dim, ~$0.06 per million input tokens.
