// Roost: knowledge retrieval (Node copy used by Vitest tests).
//
// Paired with supabase/functions/_shared/retrieval.ts (Deno). The
// canonical block between SHARED_RUNTIME_START / SHARED_RUNTIME_END
// must stay byte-equivalent (modulo comments and whitespace) to the
// Deno copy. Run `npm run check:parity`.

import type { SupabaseClient } from '@supabase/supabase-js';
import { embedQuery, type EmbedOptions } from './embeddings.js';
