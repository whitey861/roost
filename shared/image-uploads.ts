...
//
// Paired with supabase/functions/_shared/image-uploads.ts (Deno copy).
// Pure helpers — no Supabase/SDK dependencies — so the Vitest suite can
// unit-test them with a fake fetch.
