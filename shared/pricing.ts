// Roost: per-model token pricing and cost calculation.
// All rates are USD per 1 million tokens. Update when Anthropic changes pricing.
// Single source of truth for cost: never compute USD anywhere else.
